        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PenaltyFee = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleBookings_ParkingSlots_ParkingSlotId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_VehicleBookings_VehicleBookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_VehicleBookingId",
                table: "Notifications",
                column: "VehicleBookingId");

            migrationBuilder.CreateIndex(
                name: "IX_ParkingLots_OperatorId",
                table: "ParkingLots",
                column: "OperatorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleBookings_ParkingSlotId",
